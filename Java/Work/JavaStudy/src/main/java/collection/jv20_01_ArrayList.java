...
public class jv20_01_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("BREAD방 번호: " + list.indexOf("BREAD"));
        list.add(1, "APPLE");
        ...
        System.out.println("GRAPE방 번호: " + list.indexOf("GRAPE"));
        list.remove(2);
        ...
        System.out.println("P: 리스트를 for문으로 출력 : ");
        ...
        System.out.println("P: 리스트를 for-each문으로 출력 : ");
        ...
        pos = Collections.binarySearch(list, "APPLE");
        ...
        // 검색2. APPLE 이 몇개 있나요?
        int count = 0;
        count = Collections.binarySearch(list, "APPLE");
